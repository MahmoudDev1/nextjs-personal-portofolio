        ...
        return (
          <div key={index} className="mx-auto max-w-[44rem] h-full py-8 flex gap-5 md:gap-10 relative" id={`step-${index}`}>
            <div className="flex-1">
              ...
              <button className="absolute text-sm sm:text-base bottom-5 sm:bottom-10 border-2 border-purple text-purple rounded px-3 py-1 transition hover:scale-105 focus:scale-100" onClick={handleBtnClick}>{item.buttonText}</button>
            </div>
